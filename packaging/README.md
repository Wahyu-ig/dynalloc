...
```bash
# .deb
dpkg-deb -I build/deb/dynalloc_0.2.1-1_all.deb    # Show info
dpkg-deb -c build/deb/dynalloc_0.2.1-1_all.deb    # Show contents

# .rpm
rpm -qpi build/rpmbuild/RPMS/noarch/dynalloc-0.2.1-1.noarch.rpm  # Info
rpm -qpl build/rpmbuild/RPMS/noarch/dynalloc-0.2.1-1.noarch.rpm  # Contents

# .pkg.tar.zst
pacman -Qip build/dynalloc-0.2.1-1-any.pkg.tar.zst  # Info
pacman -Qlp build/dynalloc-0.2.1-1-any.pkg.tar.zst  # Contents
```
