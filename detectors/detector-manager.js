...
let _EventBusClass = null;
try { _EventBusClass = require('../policy-engine/event-bus').EventBus; } catch (_) { /* PE not available */ }
...
class DetectorManager {
  ...
  constructor(opts) {
    ...
    this._bus = opts.bus || (_EventBusClass ? new _EventBusClass() : null);
