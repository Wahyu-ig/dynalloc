...
run "mkdir -p $PREFIX/policy-engine $PREFIX/plugins $PREFIX/systemd $PREFIX/detectors $PREFIX/profiles $PREFIX/adaptive $PREFIX/recognition $PREFIX/monitoring $PREFIX/sdk $PREFIX/lib/controllers $PREFIX/intelligence"
...
run "cp -a $SCRIPT_DIR/intelligence/*.js $PREFIX/intelligence/"
