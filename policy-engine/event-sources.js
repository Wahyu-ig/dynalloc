...
class EventSources {
  ...
  constructor(deps) {
    ...
    this._cpuHighThreshold = typeof this._config.PSI_CPU_WARN === 'number' ? this._config.PSI_CPU_WARN : 8.0;
    this._memPressureThreshold = typeof this._config.PSI_MEM_WARN === 'number' ? this._config.PSI_MEM_WARN : 4.0;
