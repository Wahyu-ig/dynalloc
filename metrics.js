...
class MetricsRegistry {
  ...
  updateDaemonResourceMetrics() {
    ...
    try {
      ...
      const hz = (typeof require('os').constants !== 'undefined' && require('os').constants.oslib && typeof require('os').constants.oslib.CLOCK_TICK === 'number') ? require('os').constants.oslib.CLOCK_TICK : 100;
